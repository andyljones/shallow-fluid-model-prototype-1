...
public class LoadingScript : MonoBehaviour {
    ...
    private const int NumberOfLatitudes = 40;
    private const int NumberOfLongitudes = 40;
    ...
    void Start ()
	{
        ...
        _simulation.InitializeSimulator(atmosphere, new Conditions() { h = 10, V = new Vector3(4, 5, 0) });
